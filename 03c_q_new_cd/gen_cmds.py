...
class GenCmds(PBPTGenQProcessToolCmds):
    def gen_command_info(self, **kwargs):
        ...
        for glas_file in glas_files:
            ...
            if (not os.path.exists(out_csv_file)):
                ...
                c_dict['out_fig_dir'] = "/bigdata/cci_biomass_data/WCM/1_deg/eco/results_0723/figs/new_cd/"
    ...
    def run_gen_commands(self):
        ...
        self.gen_command_info(
            ...
            out_csv_dir="/bigdata/cci_biomass_data/WCM/1_deg/eco/results_0723/csvs/new_cd",
            out_fig_dir="/bigdata/cci_biomass_data/WCM/1_deg/eco/results_0723/figs/new_cd")
